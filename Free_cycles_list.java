...
public class Free_cycles_list extends AppCompatActivity {
...
CollectionReference cyclesRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cyclesRef.whereEqualTo("status","available").whereEqualTo("condition","undamaged").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(Free_cycles_list.this, "Error getting documents", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
