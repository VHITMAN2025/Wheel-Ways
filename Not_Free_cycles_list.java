...
public class Not_Free_cycles_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cyclesRef.whereEqualTo("status","unavailable").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(Not_Free_cycles_list.this, "Error getting documents", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
