...
public class Damaged_cycles_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cyclesRef.whereEqualTo("condition","damaged").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(Damaged_cycles_list.this, "Error getting documents", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
